...
We initialize the system by cleaning words as they are input - genericizing punctuations, hash mentions, @-mentions, and the like. We also introduce an #UNK# term to optimize our results further, for terms being seen for the first time. Further elaboration on this data cleaning can be found in section \ref{sec:cleaning}.
